...
Read it here: [init-html-starter-kit](https://github.com/sai4ul/init-html-starter-kit).
...
The documentation files are located in the [docs](https://github.com/sai4ul/init-html-starter-kit) directory. All these markdown files will be loaded in the build of the lucide.dev website.

Feel free to write, adjust or add new markdown files to improve our documentation.

## Support

If you need any help or have problems with you contribution. Please don't hesitate to contact the kit Community, you can find us on [Github](https://github.com/sai4ul/init-html-starter-kit) and [Skype](https://join.skype.com/invite/qMm0YHEpFhAB).
